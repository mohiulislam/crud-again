...
class Table extends DataTableComponent
{
    ...
    public function configure(): void
    {
       ...
       public function columns(): array
            ...
            Column::make("Title", "title")->searchable()->sortable(),            Column::make("Description", "description")->searchable()->sortable(),            Column::make("Date", "date")->searchable()->sortable(),
    ...
    {
        $this->dispatch('openModal',  component: 'notes.edit', data: ['id' => $id]);
    }
