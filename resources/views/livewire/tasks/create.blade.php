        ...
        <div class="flex items-center justify-center min-h-full p-4 sm:p-0">
            <div class="w-full max-w-lg px-6 py-8 mx-auto bg-white rounded-lg shadow-lg sm:px-10">
                ...
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-2xl font-bold text-gray-900" id="modal-title">Create Task</h3>
            ...
            <div>
                <x-input label="{{__('Start Date')}}" name="start_date" type="date"  wire:model="start_date"
                    placeholder="{{__('Start Date')}}" />
            </div>

            <div>
                <x-input label="{{__('End Date')}}" name="end_date" type="date"  wire:model="end_date"
                    placeholder="{{__('End Date')}}" />
            </div>


                    <div>
                        <x-radio id="right-label" label="{{__('Yes')}}" name="completed" value="1" wire:model="completed" />
                        <x-radio id="right-label" label="{{__('No')}}" name="completed" value="0" wire:model="completed"  class="mt-2" />
                    </div>
